...
export function WordSlideContent({
  ...
  if (slide.cardType === 'summary') {
    return (
      <div className="flex-1 flex flex-col justify-center px-6 pb-4">
        <p className="text-[15px] font-medium leading-[1.8] text-[#777777] break-keep">{slide.body}</p>
      </div>
    );
  }
  ...
  if (slide.cardType === 'content') {
    return (
      <div className="flex-1 flex flex-col justify-center px-6 pb-4">
        <p className="text-[15px] leading-[1.9] text-[#777777] font-medium break-keep">{slide.body}</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex-1 flex flex-col justify-center px-6 pb-4">
        <div className="border-l-2 pl-4 border-[#E5E5E5]">
          <p className="text-[15px] leading-[1.9] text-[#777777] font-medium break-keep">&ldquo;{slide.body}&rdquo;</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-col">
          {slide.tags?.map((tag, i) => (
            ...
            >
              ...
              <p className="text-[15px] font-semibold text-[#555555] break-keep flex-1">{tag}</p>
