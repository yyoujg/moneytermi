...
const TEMPLATE_CODE = 'moneytermi-DAILY_TERM_PUSH3'; // 콘솔 기능성 캠페인 발송 코드(templateSetCode)와 일치 (moneytermi- 접두사는 콘솔 자동 부여). PUSH2(캠페인 39540)는 이동 URL 오입력 + 발송됨 상태라 수정 불가 → 캠페인 123696/PUSH3으로 교체
