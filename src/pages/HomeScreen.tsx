      ...
      <div className="pt-4 px-5 pb-4">
        ...
        <Card pad="lg" className="mb-4">
          ...
          <div className="flex flex-col" style={{ gap: 12 }}>
            <button
              onClick={() => { if (isNewUser) logClick('home_cta_click'); logClick('course_start', { course_id: nextCourse.id, title: nextCourse.title }); const words = isNewUser && nextCourse.words.length > 0 ? [nextCourse.words[0]] : nextCourse.words; navigate('/word-card', { state: { words, index: 0, backPath: '/home', autoAdvance: true } }); }}
