...
|------|--------------------|--------------------|-----------|
| 2026092x-1xx (콘솔 확인 후 기입, deploymentId `01a0dbf2`) | 배포됨 2026-09-26 13:21 KST · 검수 요청 전 (PR #49) | — | **단어 뜻 747개 전면 재작성**·슬래시 항목 분리·퀴즈 정답 노출 수정, 닉네임 저장 버그, 포인트 축하 모달, 진동 반응 속도 |
...
## 2026-09-26 머지 / 2026-09-26 13:21 배포 (PR #49, 검수 요청 전) — 단어 뜻 전면 재작성 · 퀴즈 정답 노출 수정
