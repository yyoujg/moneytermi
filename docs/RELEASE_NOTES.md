...
|------|--------------------|--------------------|-----------|
| 20260926-139 (deploymentId `01a0dbf2`) | 생성 2026-09-26 13:21 · **검토 중** (PR #49) | — (출시 후 기입) | **단어 뜻 747개 전면 재작성**·슬래시 항목 분리·퀴즈 정답 노출 수정, 닉네임 저장 버그, 포인트 축하 모달, 진동 반응 속도 |
...
## 2026-09-26 머지 / 13:21 배포 · 검토 중 (번들 20260926-139, PR #49) — 단어 뜻 전면 재작성 · 퀴즈 정답 노출 수정
