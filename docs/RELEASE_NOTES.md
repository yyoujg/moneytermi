...
|------|--------------------|--------------------|-----------|
| 2026092x-1xx (콘솔 확인 후 기입, 머지 후 deploymentId 기입) | 출시 대기 (PR #50) | — | 단어카드 '자세히' 본문 용어 하이라이트, 뉴스 키워드 정규식 이스케이프 |
...
## 2026-09-2x 머지 / 출시 대기 (PR #50) — 단어카드 '자세히' 용어 하이라이트

머지 후 CI run·deploymentId·실기기 링크를 여기에 기입. 서버 변경 없음(코드만).
