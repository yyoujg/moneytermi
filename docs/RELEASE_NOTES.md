...
|------|--------------------|--------------------|-----------|
| 20260922-1xx (콘솔 확인 후 기입) | 출시 대기 | — | PR #33·#34·#36·#37 통합: 계측 보정, 뉴스 외부 링크 제거, CI env 주입(리워드 광고·친구 초대 실제 도달), NavBar 가림 해소, 자체 뒤로가기 4곳 제거, MY→마이 |
...
## 2026-09-22 커밋 / 출시 대기 (번들 20260922-1xx, PR #34·#36·#37) — 하단 NavBar 가림 해소 + 자체 뒤로가기 제거 + 검수 문구 대응
