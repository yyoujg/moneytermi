...
| 2026092x-1xx (콘솔 확인 후 기입, deploymentId `01a0d5c8`) | 배포됨 08:38 KST · 검수 요청 전 (2026-09-25 머지, PR #41~#44) | — | 앱 전면 개편: 학습 코스 → 세로 패스(주제별 37코스, 코스 간 잠금), 리그(주간 XP 랭킹), XP/포인트 분리 + **포인트 경제(레슨 10P · XP 50마다 +50P · 부족 시 광고)**, 미션 5종·8시간 리셋, 배지, 랜덤 닉네임, 전역 상단바, 800선 716단어 교체, 전역 모션 |
...
CI 배포 4회: run 36031409503(02:02, `01a0d45d`) → 상단 여백 → PR #42(08:03, `01a0d5a9`) → 실기기 깜박임·멈춤 → PR #43(08:32, `01a0d5c2`) → 효과음·진동 → PR #44 run 36073676796(08:38).
**검수용 최신 deploymentId `01a0d5c8-72aa-73f8-832a-e9fe9727753d`**,
실기기 테스트 링크 `intoss-private://moneytermi?_deploymentId=01a0d5c8-72aa-73f8-832a-e9fe9727753d&host=appsInTossHost`.
